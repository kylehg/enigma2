...
Function.extend({bindWithEvent:function(B,A){return this.create({bind:B,"arguments":A,event:Event});}});window.extend({getWidth:function(){if(this.webkit419){return this.innerWidth;
